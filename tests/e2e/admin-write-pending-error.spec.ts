...
test("spec093 manifest: eighteen current records with exact PNG hashes", () => {
  ...
  writeFileSync(
    ...
    [
      ...
      "",
      "2026-09-07 spec094 재검증: upload-failed/head-failed 6PNG·측정·해시를 문구 수정 후 갱신했다.",
      "나머지12PNG는093과 byte 동일. F-9 해소 판정과 현재 시각 결과는",
      "[094 검수](../../../codex-claude-handoff/reviews/2026-09-07-spec-094-admin-c5-recovery-guidance.md) 참조.",
      "수정 전093 증거는 `1e322c1`에 보존되며 과거 판정과 현재 PNG를 혼동하지 않는다.",
      "",
