...
2026-09-11 기준76ebe36=origin0/0. 사용자의스펙간루틴지시로125계약작성·자체검토후착수.
[계약](../rebuild/specs/125-background-absence-paint-lease.md),
[검토](../codex-claude-handoff/reviews/2026-09-11-spec-125-background-absence-paint-review.md).
명시paintfactory만추가하고기존sizefactory불변,기존100/123연결·UI/실사진/운영0.
code3/docs7,보호23/번들3기준불변. 검증결과는실행후기록한다.
