...
상태: **🔎 스펙 031 조사 보완 라운드 1 완료 → `READY_FOR_CODEX`. **시계의 제품 의미는 `UNCONFIRMED`**(물리적 하드웨어 미리보기 vs 인쇄 그래픽) — Founder F-4 결정 대기. 스펙 027~030은 승인·종료. 구현 미착수. ⚠️ working tree의 스펙 018 PNG 2개는 복원·커밋하지 않는다.**
