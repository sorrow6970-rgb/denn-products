...
상태: **🔎 스펙 032 사전 조사(인쇄/내보내기) 완료 → `READY_FOR_CODEX`. 스펙 027~031은 승인·종료. 인쇄 구현 미착수(Founder 결정 6건 대기). ⚠️ working tree의 스펙 018 PNG 2개와 content diff 0인 `packages/render/src/plan/index.ts`는 복원·커밋하지 않는다.**
