...
active_unit: spec-083-admin-space-v2-issue-ui   # Codex correction round 2 required; no round 2 code yet
state: CORRECTION_REQUIRED
baseline_commit: 749b2f2   # HEAD=origin at Codex correction round 2 verdict
candidate_commit: 7ce9ab4  # spec 083 correction round 1 (Codex review docs committed as 1d03bfc)
verified_commit: 048388b   # spec 082 correction round 7 independently verified by Codex
origin_relation: "HEAD=origin=749b2f2 at review, ahead/behind 0/0"
working_tree: "Codex round 2 review docs are modified and unstaged; protected spec-018 PNGs and pre-existing Founder/user changes remain dirty and unstaged"
fix_round: 2
max_fix_rounds: 3
next_transition: CLAUDE_SPEC_083_CORRECTION_ROUND_2
automation_loop: stopped (manual Claude Code -> live log -> Codex review -> next prompt handoff only)
session_status: STOP after non-deterministic mandatory E2E failure; resume round 2 only by manual handoff
